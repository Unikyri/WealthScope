...
_$PortfolioRiskDtoImpl _$$PortfolioRiskDtoImplFromJson(
        Map<String, dynamic> json) =>
    _$PortfolioRiskDtoImpl(
...
Map<String, dynamic> _$$PortfolioRiskDtoImplToJson(
        _$PortfolioRiskDtoImpl instance) =>
    <String, dynamic>{
